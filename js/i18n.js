...
const T = {
  ...
  'passes.eyebrow':   { en: 'Nothing to learn', ca: 'No has d’aprendre res', es: 'No tienes que aprender nada' },
  'passes.title':     { en: 'Three steps, and the video is on your phone.',
                        ca: 'Tres passes, i el vídeo ja és al telèfon.',
                        es: 'Tres pasos, y el vídeo ya está en el teléfono.' },
  'passes.lede':      { en: 'No timeline, no layers, no exporting. If you have ever used the camera on your phone, you already know how to use this.',
                        ca: 'Ni línia de temps, ni capes, ni exportar. Si alguna vegada has fet servir la càmera del telèfon, ja en saps.',
                        es: 'Ni línea de tiempo, ni capas, ni exportar. Si alguna vez has usado la cámara del teléfono, ya sabes.' },
  'passes.1':         { en: 'Paste the text', ca: 'Enganxa el text', es: 'Pega el texto' },
  'passes.1.desc':    { en: 'From Notes, from Mail, from wherever you wrote it. Or import a TXT, Markdown or RTF file.',
                        ca: 'De Notes, del correu, d’on l’hagis escrit. O importa un fitxer TXT, Markdown o RTF.',
                        es: 'De Notas, del correo, de donde lo hayas escrito. O importa un archivo TXT, Markdown o RTF.' },
  'passes.2':         { en: 'Press record', ca: 'Prem gravar', es: 'Pulsa grabar' },
  'passes.2.desc':    { en: 'The countdown starts and the script starts moving on its own. Change the pace while you talk.',
                        ca: 'Comença el compte enrere i el guió es posa en marxa sol. Canvia el ritme mentre parles.',
                        es: 'Empieza la cuenta atrás y el guion se pone en marcha solo. Cambia el ritmo mientras hablas.' },
  'passes.3':         { en: 'It’s in your camera roll', ca: 'Ja el tens a la galeria', es: 'Ya lo tienes en la galería' },
  'passes.3.desc':    { en: 'Nothing to render and nothing to export. The video is saved and you publish it from there.',
                        ca: 'No hi ha res a renderitzar ni a exportar. El vídeo queda desat i el publiques des d’allà.',
                        es: 'No hay nada que renderizar ni exportar. El vídeo queda guardado y lo publicas desde ahí.' },
