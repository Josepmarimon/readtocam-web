...
const T = {
  ...
  'who.title':        { en: 'Not everyone reads a script for the same reason.',
                        ca: 'No tothom llegeix un guió pel mateix motiu.',
                        es: 'No todo el mundo lee un guion por el mismo motivo.' },

  'who.1.role':       { en: 'Influencers',          ca: 'Influencers',         es: 'Influencers' },
  'who.1.title':      { en: 'Everything you need fits in a pocket.',
                        ca: 'Tot el que et cal cap a la butxaca.',
                        es: 'Todo lo que necesitas cabe en un bolsillo.' },
  'who.1.body':       { en: 'No teleprompter, no second screen, nobody holding cards off camera. Wherever you can hold the phone up, you can record something that sounds prepared.',
                        ca: 'Sense teleprompter, sense una segona pantalla, sense ningú aguantant cartrons fora de camp. Allà on puguis aixecar el telèfon, pots gravar una cosa que sona preparada.',
                        es: 'Sin teleprompter, sin una segunda pantalla, sin nadie sujetando cartones fuera de cámara. Donde puedas levantar el teléfono, puedes grabar algo que suena preparado.' },

  'who.2.role':       { en: 'Journalists',          ca: 'Periodistes',         es: 'Periodistas' },
  'who.2.title':      { en: 'Names and figures stop depending on your memory.',
                        ca: 'Els noms i les xifres deixen de dependre de la memòria.',
                        es: 'Los nombres y las cifras dejan de depender de tu memoria.' },
  'who.2.body':       { en: 'A surname, a date, the name of a street. What is hardest to hold in your head is exactly what you cannot get wrong, and it is on screen while you look at the lens.',
                        ca: 'Un cognom, una data, el nom d’un carrer. El que costa més de retenir és justament el que no pots equivocar, i el tens a la pantalla mentre mires a l’objectiu.',
                        es: 'Un apellido, una fecha, el nombre de una calle. Lo que más cuesta retener es justo lo que no puedes equivocar, y lo tienes en la pantalla mientras miras al objetivo.' },

  'who.3.role':       { en: 'Teachers',             ca: 'Docents',             es: 'Docentes' },
  'who.3.title':      { en: 'One take instead of ten.',
                        ca: 'Una presa en comptes de deu.',
                        es: 'Una toma en lugar de diez.' },
  'who.3.body':       { en: 'Recording a lesson on a Tuesday afternoon should not cost an hour of repeating the same two minutes. You read it, you record it and you get on with the rest.',
                        ca: 'Gravar una classe un dimarts a la tarda no hauria de costar una hora repetint els mateixos dos minuts. La llegeixes, la graves i passes a una altra cosa.',
                        es: 'Grabar una clase un martes por la tarde no debería costar una hora repitiendo los mismos dos minutos. La lees, la grabas y pasas a otra cosa.' },

  'who.4.role':       { en: 'Content creators',     ca: 'Creadors de contingut', es: 'Creadores de contenido' },
  'who.4.title':      { en: 'The take goes into how you say it.',
                        ca: 'La presa se’n va en com ho dius.',
                        es: 'La toma se va en cómo lo dices.' },
  'who.4.body':       { en: 'It is not going into remembering any more. The pauses, where you put the emphasis, where you look: that is what separates a video someone finishes from one they scroll past.',
                        ca: 'Ja no se’n va a recordar-ho. Les pauses, on carregues l’èmfasi, on mires: això és el que separa un vídeo que algú s’acaba d’un que es passa de llarg.',
                        es: 'Ya no se va en recordarlo. Las pausas, dónde pones el énfasis, dónde miras: eso es lo que separa un vídeo que alguien termina de uno que se salta.' },
  ...
  'close.title':      { en: 'Read your script and record.',
                        ca: 'Llegeix el guió i grava.',
                        es: 'Lee el guion y graba.' },
