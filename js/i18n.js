...
const T = {
  ...
  'feed.eyebrow':     { en: 'Before the platform', ca: 'Abans de la plataforma', es: 'Antes de la plataforma' },
  'feed.title':       { en: 'Create outside the feed.',
                        ca: 'Crea fora del feed.',
                        es: 'Crea fuera del feed.' },
  'feed.lede':        { en: "Your video doesn't have to start inside Instagram, TikTok or YouTube. Record a clean take first, on your own phone. Then decide where it goes.",
                        ca: 'El teu vídeo no ha de començar dins d’Instagram, TikTok o YouTube. Grava primer una presa neta, al teu telèfon. Després ja decidiràs on va.',
                        es: 'Tu vídeo no tiene por qué empezar dentro de Instagram, TikTok o YouTube. Graba primero una toma limpia, en tu teléfono. Después ya decidirás dónde va.' },
  'feed.peu':         { en: 'One recording, saved to your phone. You decide where it ends up — and nothing is published until you do it.',
                        ca: 'Una gravació, desada al teu telèfon. Tu decideixes on acaba, i no es publica res fins que ho fas tu.',
                        es: 'Una grabación, guardada en tu teléfono. Tú decides dónde acaba, y no se publica nada hasta que lo haces tú.' },
