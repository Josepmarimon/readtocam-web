...
const T = {
  ...
  'problem.eyebrow':  { en: 'The real problem',     ca: 'El problema de debò', es: 'El problema de verdad' },
  'problem.title':    { en: 'Fifteen takes of the same thirty seconds.',
                        ca: 'Quinze preses dels mateixos trenta segons.',
                        es: 'Quince tomas de los mismos treinta segundos.' },
  'problem.q1':       { en: '“I forget what I wanted to say the moment I hit record.”',
                        ca: '«Se m’oblida el que volia dir just quan començo a gravar.»',
                        es: '«Se me olvida lo que quería decir justo cuando empiezo a grabar.»' },
  'problem.q2':       { en: '“If I read it, you can tell I’m not looking at the camera.”',
                        ca: '«Si ho llegeixo, se’m nota que no miro a càmera.»',
                        es: '«Si lo leo, se me nota que no miro a cámara.»' },
  'problem.q3':       { en: '“I end up with a camera roll full of takes that are worth nothing.”',
                        ca: '«Acabo amb el carret ple d’intents que no valen res.»',
                        es: '«Acabo con el carrete lleno de intentos que no valen nada.»' },
  'problem.q4':       { en: '“Memorising it is a lot of work for a thirty-second video.”',
                        ca: '«Memoritzar-ho és una feinada per a un vídeo de trenta segons.»',
                        es: '«Memorizarlo es un trabajo enorme para un vídeo de treinta segundos.»' },
  'problem.verdict':  { en: 'None of this is a camera problem.',
                        ca: 'Res d’això és un problema de càmera.',
                        es: 'Nada de esto es un problema de cámara.' },
